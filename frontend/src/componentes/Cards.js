            ...
            <Link to={`/medidas/${projeto._id}`}>
                <Content>
                    ...
                    <Info>
                        ...
                        <h6>Luminosidade: <span style={{color: projeto.medidas[ultimo-1].luminosidade > 15 ? "#ff0000" : "#00cc00", fontWeight: "bold"}}>{projeto.medidas[ultimo-1].luminosidade}cd</span></h6>
                        ...
                        <h6>Fumaça: <span style={{color: projeto.medidas[ultimo-1].fumaca < 800 ? "#ff0000" : "#00cc00", fontWeight: "bold"}}>{projeto.medidas[ultimo-1].fumaca}</span></h6>
                        <h6>Ruído: <span style={{color: projeto.medidas[ultimo-1].ruido < 800 ? "#ff0000" : "#00cc00", fontWeight: "bold"}}>{projeto.medidas[ultimo-1].ruido}dB</span></h6>
                    </Info>
                </Content>
            </Link>
        </StyledCard>
